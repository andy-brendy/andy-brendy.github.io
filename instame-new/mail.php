...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  if (!empty($_POST['uname']) && (!empty($_POST['uemail']) || !empty($_POST['uphone']))){
    ...
    $to = "projectinstame@gmail.com"; /*Укажите адрес, на который должно приходить письмо*/
    $sendfrom = "mail@instame-lux.ru"; /*Укажите адрес, с которого будет приходить письмо */
  ...
  header ("Location: http://instame-lux.ru"); // главная страница вашего лендинга
}
