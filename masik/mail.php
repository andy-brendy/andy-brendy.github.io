...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  if (!empty($_POST['uname']) && (!empty($_POST['uemail']) || !empty($_POST['uphone']))){
    ...
    $to = "targetinstdimas@gmail.com"; /*Укажите адрес, на который должно приходить письмо*/
    $sendfrom = "mail@masik-studia.ru"; /*Укажите адрес, с которого будет приходить письмо */
  ...
  header ("Location: http://masik-studia.ru"); // главная страница вашего лендинга
}
